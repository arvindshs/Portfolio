...
function About() {
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#0A0F2C] to-[#1A2238] flex flex-col items-center justify-center px-8 py-16 space-y-20 overflow-hidden">
      {/* About Section */}
      <div className="flex flex-col md:flex-row items-center justify-center gap-20 w-full max-w-7xl relative">
        {/* Floating background graphic */}
        <motion.div
          className="absolute top-[-100px] left-[-100px] w-[400px] h-[400px] bg-[#D72638] opacity-20 rounded-full blur-3xl"
        ...
        >
          <motion.img
            src={profilePic}
            alt="Profile"
            className="w-[400px] h-[400px] object-cover rounded-3xl shadow-2xl"
        ...
        >
          <h1 className="text-5xl font-italiana text-white mb-6">About Me</h1>
      ...
      <div className="w-full max-w-5xl text-center space-y-6 relative z-10">
        <motion.h2
          className="text-4xl font-italiana text-white"
