...
function Hero() {
  return (
    <div className="flex flex-col items-center justify-center px-8 md:px-[100px] py-[100px]">
      {/* Left Section - Text */}
      <div className="flex flex-col gap-[40px] text-center md:max-w-2xl">
        <h5 className="text-5xl font-italiana text-[#0A0F2C]">Mirrored Mind</h5>
        <h1 className="text-4xl md:text-8xl font-italiana tracking-[1px] text-[#0A0F2C]">
          The <span className="text-[#D72638]">code</span> speaks logic.
          <br /> The <span className="text-[#D72638]">design</span> screams
          soul.
        </h1>
      ...
      <div className="flex gap-[30px] mt-[40px] justify-center flex-col md:flex-row">
        <a
          href="https://github.com/arvindshs"
          target="_blank"
          rel="noopener noreferrer"
